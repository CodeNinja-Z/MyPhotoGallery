describe Like, type: :model do
  describe '#like_photo' do
    it 'successfully create a like' do
      # Create mock up user and photo in the method since not using
      # FactoryGirl and not using ActiveRecord for Photo model
      ...
      like = Like.create(user_id: user.id, photo_uid: photo['id'])
      like.user = user
